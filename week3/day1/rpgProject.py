...
line_five = input("...As you approach Vivian, she pretends she doesn't know who you are and asks you what your name is to try to make you feel small. (Press enter to continue)") 
...
while len(name_or_run_choice) > -1:
    if len(name_or_run_choice) > 0 and name_or_run_choice != "1":
        line_five = input(f"""You: "Come on Vivian! You know that my name is {name_or_run_choice}! Now, let's get this battle over with. I have an interview to get to!" (Press enter to continue)""")
        line_six = input("Now, you have to decide which character you would like to be during battle. (Press enter to see the menu of characters to choose from)")
